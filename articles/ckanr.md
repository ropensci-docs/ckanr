...
<http://data.techno-science.ca/>. You can change this using
[`ckanr_setup()`](https://docs.ropensci.org/ckanr/reference/ckanr_setup.md),
or change the URL using the `url` parameter in each function call.
...
`ckanr` implements a `dplyr` SQL interface to CKAN’s datastore. You can
access any resource in the datastore directly using only the CKAN
resource ID.

Note: this will only work for resources which were uploaded successfully
to the datastore - they will show the green “Data API” button in CKAN.
...
for a list of CKAN servers. Ther are 127 as of 2020-07-29.
