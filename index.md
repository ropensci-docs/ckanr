...
CKAN is an open-source DMS (data management system) for powering data
hubs and data portals. CKAN makes it easy to publish, share and use
data. It powers hundreds of data portals worldwide.
...
privileged CKAN API key. You can change this using
[`ckanr_setup()`](https://docs.ropensci.org/ckanr/reference/ckanr_setup.md),
or change the URL using the `url` parameter in each function call. To
set one or both, run:
...
- License: MIT
- Get citation information for `ckanr` in R via
